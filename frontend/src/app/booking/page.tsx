...
// 1. Kita pisahkan isi Form-nya ke komponen sendiri
      ...
      <form className="space-y-6">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div>
            ...
            <input type="text" placeholder="Nama Anda" className="w-full bg-slate-50 border-none rounded-2xl px-4 py-4 outline-none focus:ring-2 focus:ring-emerald-500" />
          </div>
          <div>
        ...
        <div>
          <label className="block text-sm font-bold text-emerald-900 mb-2">Alamat Lengkap</label>
          <textarea placeholder="Alamat Panggilan di Lumajang" className="w-full bg-slate-50 border-none rounded-2xl px-4 py-4 outline-none focus:ring-2 focus:ring-emerald-500 h-32"></textarea>
        </div>

        <button type="submit" className="w-full bg-emerald-900 text-white py-5 rounded-full font-bold text-lg hover:bg-emerald-800 shadow-lg transition-all active:scale-95">
          Konfirmasi Booking
        </button>
      </form>
    </div>
...
// 2. Halaman utama membungkus BookingContent dengan Suspense
export default function BookingPage() {
  return (
    <main className="min-h-screen bg-slate-50">
      <Navbar />
      <div className="pt-32 pb-20 px-6">
        {/* Suspense ini adalah kunci biar deploy tidak error */}
        <Suspense fallback={
          <div className="flex flex-col items-center justify-center py-20 text-emerald-900">
            ...
            <p className="font-bold">Menyiapkan Form Senzia...</p>
          </div>
        }>
          <BookingContent />
        </Suspense>
